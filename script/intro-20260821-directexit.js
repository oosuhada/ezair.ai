...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function finishIntroFallback(message) {
        ...
        document.dispatchEvent(new CustomEvent('ezair:intro-complete'));
    }
    ...
    function startIntroAnimation() {
        ...
        if (typeof gsap === 'undefined') {
            finishIntroFallback('Error: GSAP is not defined.');
            return;
        }
        ...
        if (aiInputBox) {
            ...
            // airplaneWindow는 fixed intro overlay의 viewport 중앙을 기준으로 이동한다.
            // 문서 scroll offset을 더하면 scroll 복원/잠금 상태에서 실제 input과 어긋난다.
        ...
        tl.to(airplaneWindow, {
            ...
            onStart: function () {
                if (aiInputBox) {
                    const placeholderText = window.EZAIR_DEFAULT_AI_QUERY
