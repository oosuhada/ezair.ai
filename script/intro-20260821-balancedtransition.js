...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function startIntroAnimation() {
        ...
        gsap.set(introAirplane, { xPercent: -50, yPercent: -50, transformOrigin: "center center" });
        ...
        if (aiInputBox) {
            ...
            targetX = (aiInputBoxRect.left + aiInputBoxRect.width / 2) - (window.innerWidth / 2);
            targetY = (aiInputBoxRect.top + aiInputBoxRect.height / 2) - (window.innerHeight / 2);
        ...
        tl.fromTo(introAirplane, { x: startX, y: startY, rotation: 135, opacity: 1 }, {
            keyframes: [
        ...
        tl.to(windowInner, { duration: 0.78, opacity: 0, ease: "power2.inOut", onComplete: function() { windowInner.style.display = 'none'; } }, ">-0.34");
        tl.to(airplaneWindow, { duration: 0.72, x: targetX, y: targetY, width: targetWidth, height: targetHeight, borderRadius: targetBorderRadius, backgroundColor: targetBackgroundColor, borderColor: targetBorderColor, boxShadow: targetBoxShadow, ease: "power2.inOut" }, ">-0.30");
